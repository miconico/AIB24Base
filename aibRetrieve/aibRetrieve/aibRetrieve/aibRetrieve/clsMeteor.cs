...
namespace aibRetrieve
{
    public class Meteor
    {
        ...
        public bool bSendText(string sTo, string sToMessage)
        {
            ...
            sURL = "https://www.mymeteor.ie/mymeteorapi/index.cfm?event=smsAjax&func=addEnteredMsisdns&ajaxRequest=addEnteredMSISDNs&remove=-&add=111111|" + "0877453339" + "|no%20one";
